...
export default function CasePageBody({ lang, page }: { lang: LabLang; page: CP }) {
  ...
  return (
    <>
      ...
      {/* `page-inner`, not `page-main`: same full-width column, but the top
          padding clears the fixed bar because this page's first child is the
          heading, not a 100svh hero. */}
